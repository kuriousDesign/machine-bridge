...
export interface RecipeData {
    bladeSpeedId: MotionProfiles;
    clampDropPositions: Array<number>;
    cutLength: number;
    dbId: string;
    dustSettlingTimeSec: number;
    feedCuttingSpeed: MotionProfiles;
    index: number;
    numClamps: number;
}
...
export interface AxisTeknicDiscreteIoCfg {
    axisType: AxisTypes;
    displaySpeeds: Array<number>;
    driveType: AxisDriveTypes;
    unit: string;
}
export interface AxisTeknicDiscreteIoSts {
...
export interface AxisTeknicDiscreteIoOutputs {
    enable: boolean;
    speedBits: Array<boolean>;
}
export interface ConOutputs {
...
export type Machine = {
    ...
    bladeCfg: AxisTeknicDiscreteIoCfg;

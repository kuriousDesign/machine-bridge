...
export const machineTypeSource = {
    ...
    "generatedAt": "2026-05-16T17:07:47.450Z",
    "rootNodeId": "ns=4;s=|var|CODESYS Control for Linux SL.Application.Machine_00225",
    "rootTag": "Machine_00225"
} as const;

export interface RecipeData_00225 {
    bladeRpmId: number;
    cutEndPosition: number;
    cutStartPosition: number;
    dustSettlingTimeSec: number;
    feedCuttingSPeed: number;
    index: number;
}
...
export interface outputs_00225 {
    LIFT: TwoPosOutputs;
    SFTY: SftyOutputs;
}
...
export interface RecipeStore_00225 {
    NumRecipes: number;
    Recipes: Array<RecipeData_00225>;
}
...
export type Machine_00225 = {
    ActiveRecipe: RecipeData_00225;
    FeedCfg: AxisCfg;
    ...
    LiftCfg: TwoPosCfg;
    LiftSts: TwoPosSts;
    outputs: outputs_00225;
    PdmSts: PartDataStatus;
    RecipeStore: RecipeStore_00225;
    SftyCfg: SftyCfg;
    SftySts: SftySts;
    TaskQueue: TaskQueue;
    UdpCfg: UdpCfg;

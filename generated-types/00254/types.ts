...
export const machineTypeSource = {
    ...
    "generatedAt": "2026-07-21T20:33:01.429Z",
...
export interface RctrlCfg {
    ...
    toolFrames: Array<string>;
    userFrames: Array<string>;
}
export interface AbbDataInputsV2 {
    ...
    autoRecoverTaskId: number;
    autoRecoveryMode: number;
    autoRecoveryNeeded: boolean;
    autoRecoveryTaskStepNum: number;
    autoRecoveryWaypointId: number;
    controllerErrorId: number;
    errorId: number;
    heartbeatRobot: number;
    homePositionRecoveryOk: boolean;
    homePositionRecoveryXDelta: number;
    homePositionRecoveryYDelta: number;
    homePositionRecoveryZDelta: number;
    lastWaypoint: number;
    nextWaypoint: number;
    stepNum: number;
    syncIdReq: number;
    ...
    tcpRotW: number;
    tcPSpeed: number;
    toolControlReq: number;
    uniqueActionActiveId: number;
    uniquePlcReqId: number;
}
...
export interface AbbInputsV2 {
    data: AbbDataInputsV2;
    sysOutputs: AbbSysOutputs;
}
export interface AbbDataOutputsV2 {
    actionId: number;
    actionType: number;
    currentPartState: number;
    dryCycle: boolean;
    heartbeatPlc: number;
    param0: number;
    param1: number;
    param2: number;
    param3: number;
    partPresentBits: number;
    senderId: number;
    syncIdDone: number;
    toolControlStsBits: number;
    toolPresentBits: number;
    uniqueActionReqId: number;
}
...
export interface AbbOutputsV2 {
    data: AbbDataOutputsV2;
    sysInputs: AbbSysInputs;
}
export interface AbbControllerInterfaceV2 {
    i: AbbInputsV2;
    o: AbbOutputsV2;
}
export interface AbbMeta {
    iController: AbbControllerInterfaceV2;
}
...
export interface AxisNonSoftMotionSts {
...
export interface RobInputs {
    beakersPresent: Array<boolean>;
    dispenserTool_PRESENT: boolean;
    extruderTool_PRESENT: boolean;
    gripperTool_PRESENT: boolean;
}
export interface SftyInputs {
    cartSw1: boolean;
    cartSw2: boolean;
    daisyChainEXT: boolean;
    doorSwitches: boolean;
    doorSwitches_ALL_ON: boolean;
    estopCircuit_OK: boolean;
    estopCircuitDelayed_OK: boolean;
    estopCircuitReset_READY: boolean;
    estopInputs_ALL_ON: boolean;
    estopPbRobot: boolean;
    estopPbScreener: boolean;
    fenceCircuit_OK: boolean;
    fenceCircuitReset_READY: boolean;
    fenceConditionForEstop_OK: boolean;
    fenceInputs_ALL_ON: boolean;
    fumeHoodSw: boolean;
    safeContactor1NC_OK: boolean;
    safeContactor2NC_OK: boolean;
    safeNC_ALL_ON: boolean;
...
export interface ConOutputs_00225 {
    timerStartRelay: boolean;
}
...
export interface SftyOutputs {
    bypassCartInputs: boolean;
    bypassFumeHoodInput: boolean;
    cartSw1Input_PASSTHRU: boolean;
    cartSw2Input_PASSTHRU: boolean;
...
export interface PartDataStatus {
    ...
    firstClampId: number;
    lastClampId: number;
    lowestPartStatus: PartStates_00225;
    maxAllowedPartsToCut: number;
    numPartsToCut: number;
...
export type Machine = {
    ...
    outputs: outputs;
    paddleCfg: AxisCfg;
    paddleSts: AxisNonSoftMotionSts;
    pdmSts: PartDataStatus;
    piston_bCfg: AxisCfg;
    piston_bSts: AxisNonSoftMotionSts;
    piston_tCfg: AxisCfg;
    piston_tSts: AxisNonSoftMotionSts;
